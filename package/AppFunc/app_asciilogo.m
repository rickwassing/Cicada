...
disp('   Vincent T. van Hees, Maxim Osipov, Bart Te Lindert, and')
disp('   German Gómez-Herrero.')
disp(' ')
disp('License:')
disp('   This work is licensed under a Creative Commons Attribution-')
disp('   ShareAlike 4.0 International License.')
disp(' ')
