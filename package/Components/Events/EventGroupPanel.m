...
classdef EventGroupPanel < CicadaComponentContainer
    % *********************************************************************
    % PROPERTIES
    properties
        EventGroupList;
    ...
    methods (Access = protected)
        ...
        function setup(Obj)
            ...
            Obj.Placeholder = Placeholder(Obj.GridLayout, ...
                ...
                'SubHeader', '', ...
                'Size', 95, ...
                'BackgroundColor', Colors.bg_secondary); %#ok<PROP>
        end
        % =================================================================
        function update(Obj)
            try
                ...
                if size(Obj.EventGroupList, 1) == 0
                    ...
                    Obj.GridLayout.RowHeight = repmat({26}, 1, max([1, size(Obj.EventGroupList, 1)]));
                end
